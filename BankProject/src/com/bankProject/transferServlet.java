	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			while(rs.next())
			{
				...
				while(rs1.next())
				{
					obalance2=rs1.getInt(4);
					nbalance2=obalance2+Amount;
					
					PreparedStatement pstmt3=con.prepareStatement("update user set Balance=? where Accno=?");
					pstmt3.setInt(1,nbalance2);
